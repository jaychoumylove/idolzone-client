...
export default {
	...
	API: {
		...
		ACTIVE_BLESSING_LIST: 'active/blessingList', // 618活动福气榜列表
		...
		ACTIVE_DRAGON_BOAT_FESTIVAL_FUNSCLUB: 'active/dragon_boat_festival_funclub', // 端午活动粉丝团列表
		ACTIVE_DRAGON_BOAT_FESTIVAL_FUNSCLUB_USER: 'active/dragon_boat_festival_funclub_user', // 端午活动粉丝团用户列表
