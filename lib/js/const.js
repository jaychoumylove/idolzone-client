...
export default {
	...
	API: {
		...
		ACTIVE_DRAGON_BOAT_FESTIVAL_FANCLUB_USER: 'active/dragon_boat_festival_fanclub_user', // 端午活动粉丝团用户列表
		...
		LUCKY_DRAW_START_FIFTY: 'lucky/draw/startfifty',// 点击抽奖
		...
		PAGE_MY_ACHIEVEMENT: "page/my_achievement", // 成就列表
