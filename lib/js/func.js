...
export default {
	...
	request(url, data = {}, success, method = 'POST', block = false) {
		...
		console.log('HTTP请求', url, data)
		// 调试token
		// data.token = 'Y1J3S2l2OGw1eVhCcjNMVmRwWHNNVFUzTnpJMU5UVTBPQ1l4TVRNdU1qSXlMalV1T1RJbU1UQTBNVFU1'
		uni.request({
	...
	// 打开视频广告
	openVideoAd(success, kindness = true) {
