...
export default {
	 ...
	 */
	request(url, data = {}, success, method = 'POST', block = false, fcallback = null) {
		// 堵塞请求
		if (block) {
			if (this.isBlock) {
				this.toast("请稍后再试")
		...
		// 调试token
		// data.token = 'Y1J3S2l2OGw1eVhCcjNMVmRwWHNNVFl3TmpJM01ERTBPU1l4TURBdU1USXhMakUxTWk0Mk1TWXpNRGc1T1RZPQ==';
		uni.request({
