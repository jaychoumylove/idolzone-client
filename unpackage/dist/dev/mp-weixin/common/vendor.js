...
_vue.default.prototype.$app = _App.default.globalData;var loadIconComponent = function loadIconComponent() {return __webpack_require__.e(/*! import() | components/loadIconComponent */ "components/loadIconComponent").then(__webpack_require__.bind(null, /*! @/components/loadIconComponent.vue */ 373));};_vue.default.component('loadIconComponent', loadIconComponent); // 阿拉丁
                                                                                                      ...
                                                                                                      */var _default =
{
  ...
  // 时间字符串转 00:00:00
  strToHour: function strToHour(str) {
    return str.slice(11);
  },
  /** 数字千分号*/
  ...
  /** 小数点后保留几位，不足4位保留原位数*/
  formatFloatNum: function formatFloatNum(number) {var pos = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;
    if (pos == 4)
    number = String(number).replace(/^(.*\..{4}).*$/, "$1");else
    if (pos == 3)
    number = String(number).replace(/^(.*\..{3}).*$/, "$1");else
    if (pos == 2)
    number = String(number).replace(/^(.*\..{2}).*$/, "$1");else
    if (pos == 1)
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 基础方法
var _default = {
  /**
                  * 基础HTTP请求
  ...
  request: function request(url) {var _this = this;var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var _success = arguments.length > 2 ? arguments[2] : undefined;var method = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'POST';var block = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    ...
    // 调试token
    // data.token = 'Y1J3S2l2OGw1eVhCcjNMVmRwWHNNVFUzTkRrNU1qUTBNU1l4TVRNdU1qSXlMakkzTGpJeE1DWXlPVFl5TWc9PQ=='
    uni.request({
      ...
      success: function success(res) {
        ...
        if (res.statusCode != 200) {
          ...
          _this.login(function () {
            _this.request(url, data, _success, method, block);
          });
  ...
  toast: function toast(content) {var icon = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'none';var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1500;
    uni.showToast({
      title: content,
      icon: icon,
      duration: duration });
  ...
  modal: function modal(content) {var callBack = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;var confirmText = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '确定';
    uni.showModal({
      title: '提示',
      content: content,
  ...
  copy: function copy(data) {var _this2 = this;
    uni.setClipboardData({
      data: data.toString(),
      success: function success() {return _this2.toast('复制成功', 'success');} });
  ...
  /**
      ...
      */
  upload: function upload(file, callBack) {var _this3 = this;
    uni.showLoading({
      title: '请稍后...' });
    ...
    var realFile = [];var _loop = function _loop(
    i) {
      if (!file[i]) {
        file.splice(i, 1);
      } else {
        uni.uploadFile({
          url: _this3.HTTP_URL + 'upload',
          filePath: file[i],
          name: 'file',
          success: function success(res) {
  ...
  // 打开视频广告
  openVideoAd: function openVideoAd(success) {var _this4 = this;var kindness = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    if (!page.videoAd) {
      ...
      page.videoAd.onClose(function (status) {
        if (status && status.isEnded || status === undefined) {
          // 可领奖励
          success && success();
        } else {
          _this4.toast('观看完视频才有奖励哦');
        }
      });

      page.videoAd.onError(function (err) {
        _this4.toast("抱歉，暂无合适的广告");
        kindness && success && success();
      });
      uni.hideLoading();
    }
    // 打开
    page.videoAd.show().catch(function (err) {
      // 失败重试
      page.videoAd.load().then(function () {
        page.videoAd.show().catch(function (err) {
          _this4.toast('视频广告创建失败');
        });
      });
    });
  },
  ...
  /**插屏广告*/
  openInterstitialAd: function openInterstitialAd() {
    var page = this.getPage();
    ...
    if (page.interstitialAd) {
      page.interstitialAd.show().catch(function (err) {
        console.log(err);
      });
    } else {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 扩展方法
var _default = {
  /**登录 */
  login: function login(callBack) {
    var getAuth = function (code) {var _this = this;
      // 通用登录接口
      this.request(this.API.AUTH_LOGIN, {
        ...
        if (res.data.token) _this.token = res.data.token;
        callBack && callBack();
      });
    }.bind(this);
  ...
  // 页面相关
  invokeSocket: function invokeSocket() {var _this2 = this;
    if (!this.socketTask || this.socketTask.readyState == 2 || this.socketTask.readyState == 3) {
      this.socketTask = uni.connectSocket({
        url: this.WSS_URL,
        success: function success(res) {return console.log('WebSocket 连接成功！', res);} });
  ...
  /**
      * 关闭全屏loading
      */
  closeLoading: function closeLoading(page) {
  ...
  commonShareAppMessage: function commonShareAppMessage(shareType) {
    ...
    if (shareType) {
      ...
      if (share) {
        ...
        if (share.path) path += "&".concat(share.path);
  ...
  /**
      ...
      */
  getCanvasImg: function getCanvasImg(canvasId, data, callback) {var _this3 = this;
    uni.showLoading({
      title: "生成海报中" });

    var ctx = uni.createCanvasContext(canvasId, this);
    var rate = this.getData('sysInfo').windowWidth / 375 / 2;
    // ---绘制图片---
    // 背景
    this.getLocalImg(data.img.bg, function (src) {
      ctx.drawImage(src, 0, 0, 480 * rate, 854 * rate);

      // 明星 
      _this3.getLocalImg(data.img.star, function (src) {
        ctx.drawImage(src, 48 * rate, 286 * rate, 382 * rate, 305 * rate);

        // 用户头像
        _this3.getLocalImg(data.img.avatar, function (src) {
          ctx.save(); //保存当前的绘图上下文。
          ...
          // 二维码
          _this3.getLocalImg(data.img.qrcode, function (src) {
            ctx.save(); //保存当前的绘图上下文。
            ctx.beginPath(); //开始创建一个路径
            ...
            ctx.fillText("\u699C\u5355\u6392\u540D:NO.".concat(data.text.weekRank), 270 * rate, 616 * rate); //绘制文本
            ctx.fillText("\u4EBA\u6C14\u503C:".concat(data.text.weekHot), 270 * rate, 640 * rate); //绘制文本

            ctx.fillText("\u6211\u662F".concat(data.text.myname), 130 * rate, 774 * rate); //绘制文本
            ctx.fillText("\u4E00\u8D77\u4E3A".concat(data.text.starname, "\u6253\u699C"), 130 * rate, 804 * rate); //绘制文本
...
/***/ 133:
/*!**************************************************************************!*\
  !*** E:/wx/idolzone-weixin/main.js?{"page":"pages%2Fuser%2Fbadge_rank"} ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _badge_rank = _interopRequireDefault(__webpack_require__(/*! ./pages/user/badge_rank.vue */ 134));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
createPage(_badge_rank.default);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["createPage"]))
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _log = _interopRequireDefault(__webpack_require__(/*! ./pages/user/log.vue */ 142));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _rank = _interopRequireDefault(__webpack_require__(/*! ./pages/user/rank.vue */ 150));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _birth_rank = _interopRequireDefault(__webpack_require__(/*! ./pages/user/birth_rank.vue */ 158));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _exchange = _interopRequireDefault(__webpack_require__(/*! ./pages/user/exchange.vue */ 166));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
exports.app_key = "f9c001b68aa6f53f464e4e16add76d4e"; //请在此行填写从阿拉丁后台获取的appkey WX
// exports.app_key = "bbb7c65a37770ddd6958452bc826e082"; //请在此行填写从阿拉丁后台获取的appkey QQ
...
"use strict";
!function (t, e) {module.exports = function () {var t = __webpack_require__(/*! ./xhtad_conf.js */ 19),e = __webpack_require__(/*! ./xhtad_md5.js */ 20);if (!t.app_key || 22 !== t.app_key.length) return console.warn("\u5C0F\u4E92\u63A8\u63D0\u793A\uFF1A\u914D\u7F6E\u9519\u8BEF\uFF0C\u8BF7\u5728xhtad_conf.js\u4E2D\u6B63\u786E\u914D\u7F6E\u60A8\u7684app_key\u3002"), !1;var n = "https://log.xiaohutui.com",u = { ak: t.app_key.replace(/(^\s*)|(\s*$)/g, ""), v: "1.3", pb: "", pm: "", sv: "", pv: "", nt: "", ww: 0, wh: 0, pr: 0, long: 0, lat: 0, wvv: "", wv: "", lang: "", pp: "", uuid: "", user_info: {} },o = 0,edata = '',a = function a() {function t() {return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1);}
      var e;try {if (e = wx.getStorageSync("xhtaduuid")) return e;} catch (t) {}
      e = t() + t() + t() + t() + t() + t() + t() + t();try {wx.setStorageSync("xhtaduuid", e);} catch (t) {}
      return e;},i = function i(t) {var e = t.split("&"),n = {};for (var u in e) {e[u] = e[u].split("="), n[e[u][0]] = e[u][1];}
      return n;},r = function r(t) {u.uuid = a(), c(t);},ca = function ca(o) {wx.getSetting({ success: function success(a) {a.authSetting["scope.userInfo"] || setTimeout(function () {wx.getSetting({ success: function success(a) {if (a.authSetting["scope.userInfo"]) {c = Date.parse(new Date()) / 1e3, s = e.hexMD5(u.ak + u.uuid + c);wx.getUserInfo({ success: function success(t) {if (!edata) return false;wx.request({ url: n + "/auth", method: "POST", data: { d_key: s, time: c, encdata: edata, uuid: u.uuid, user_info: t.userInfo }, success: function success() {} });} });} else ca(o);} });}, 6000);} });},c = function c(o) {edata = 1037 == o.scene ? (o.referrerInfo.extraData || {}).encdata || o.query.encdata : i(decodeURIComponent(o.query.scene)).encdata, wx.login({ success: function success(t) {if (!edata) return false;var e = { jscode: encodeURIComponent(t.code), uuid: u.uuid, appkey: u.ak, encdata: edata };wx.request({ url: n + "/log/stat/init", method: "post", data: e });}, fail: function fail() {} }), ca(o);},s = function s(t, e, n) {var u = t[e];t[e] = function (t) {u && u.call(this, t), n.call(this, t);};},f = function f(t) {var e = App;App = function App(t) {s(t, "onLaunch", r), e(t);};};return f();}();}();
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _starinfo = _interopRequireDefault(__webpack_require__(/*! ./pages/user/starinfo.vue */ 182));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _edit_user = _interopRequireDefault(__webpack_require__(/*! ./pages/user/edit_user.vue */ 190));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
exports.app_key = 'xhutuice82873f0d3568a4'; //app_key可从小虎推后台接入SDK处获取
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _article = _interopRequireDefault(__webpack_require__(/*! ./pages/square/article.vue */ 198));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _task = _interopRequireDefault(__webpack_require__(/*! ./pages/task/task.vue */ 206));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _open = _interopRequireDefault(__webpack_require__(/*! ./pages/open/open.vue */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _game = _interopRequireDefault(__webpack_require__(/*! ./pages/task/game.vue */ 214));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _notice = _interopRequireDefault(__webpack_require__(/*! ./pages/notice/notice.vue */ 222));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/notice/list.vue */ 230));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _pk_index = _interopRequireDefault(__webpack_require__(/*! ./pages/pk/pk_index.vue */ 238));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _pk_rank = _interopRequireDefault(__webpack_require__(/*! ./pages/pk/pk_rank.vue */ 246));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _pk_rank_user = _interopRequireDefault(__webpack_require__(/*! ./pages/pk/pk_rank_user.vue */ 254));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _lottery = _interopRequireDefault(__webpack_require__(/*! ./pages/lottery/lottery.vue */ 262));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _log = _interopRequireDefault(__webpack_require__(/*! ./pages/lottery/log.vue */ 270));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
createPage(_log.default);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["createPage"]))
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _box = _interopRequireDefault(__webpack_require__(/*! ./pages/lottery/box.vue */ 278));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _box_open = _interopRequireDefault(__webpack_require__(/*! ./pages/lottery/box_open.vue */ 286));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _active_one = _interopRequireDefault(__webpack_require__(/*! ./pages/active_one/active_one.vue */ 294));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _active_one_list = _interopRequireDefault(__webpack_require__(/*! ./pages/active_one/active_one_list.vue */ 302));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _score = _interopRequireDefault(__webpack_require__(/*! ./pages/score/score.vue */ 310));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _redress = _interopRequireDefault(__webpack_require__(/*! ./pages/redress/redress.vue */ 318));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _fans_list = _interopRequireDefault(__webpack_require__(/*! ./pages/fans/fans_list.vue */ 326));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _fans_club = _interopRequireDefault(__webpack_require__(/*! ./pages/fans/fans_club.vue */ 334));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _mass = _interopRequireDefault(__webpack_require__(/*! ./pages/fans/mass.vue */ 342));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _fans_new = _interopRequireDefault(__webpack_require__(/*! ./pages/fans/fans_new.vue */ 350));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _member = _interopRequireDefault(__webpack_require__(/*! ./pages/fans/member.vue */ 358));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _charge = _interopRequireDefault(__webpack_require__(/*! ./pages/charge/charge.vue */ 366));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _const = _interopRequireDefault(__webpack_require__(/*! @/lib/js/const */ 9));
var _base_func = _interopRequireDefault(__webpack_require__(/*! @/lib/js/base_func */ 10));
var _func = _interopRequireDefault(__webpack_require__(/*! @/lib/js/func */ 11));
var _ext_func = _interopRequireDefault(__webpack_require__(/*! @/lib/js/ext_func */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = _objectSpread({},


_const.default,
_base_func.default,
_func.default,
_ext_func.default);exports.default = _default;
...

{
  ...
  bannerAdUnitId: "adunit-5da989a2ff240268", // banner广告id
  interstitialAd_adUnitId: "adunit-4df217a6aa658534", // 插屏广告id

  // QQ广告
  qq_adUnitId: "8904b200c40eed73768c996238283236", // QQ激励视频广告id
  qq_interstitialAd_adUnitId: "da060831e67b8521a3df7a99edac3df9", // 卡片广告id
  qq_bannerAdUnitId: "7c1437fc5d59c41fcd7b0a8b5ab15985", // banner广告位
