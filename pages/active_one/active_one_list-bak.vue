<template>
	<view class="active_one-container">
		...
		<view class="active-center-container" @tap="goPage(item.id)" v-for="(item,index) in activeList"
		 :key="index">
			<view class="top-wrap">
				<view class="left">
				...
				<view class="right">
					<view class="t flex-set">  
						<image class="img-s" src="https://mmbiz.qpic.cn/mmbiz_png/w5pLFvdua9FquzibbuL4TMQyMbRKaQyUhVASTtX19eaicWuYURtPGCyKFGsNZVG7t8LgzXic1dtCY4o4EqvKLicJ5w/0" mode=""></image>
					为爱解锁</view>
				</view>
			</view>
			...
			<view class="progress-wrap">
				...
				<view class="progress">
					<progress activeColor="#e02d2d" stroke-width="10" backgroundColor="#f9f9f9" :percent="item.progress.join_people/item.target_people*100" />
					<text style="color:#e02d2d;">参与人数{{item.progress.join_people||0}}</text>
				</view>
				<view class="progress">
					<progress activeColor="#962de0" stroke-width="10" backgroundColor="#f9f9f9" :percent="item.progress.complete_people/item.target_people*100" />
					<text style="color:#962de0;">完成人数{{item.progress.complete_people||0}}</text>
				</view>
			...
			<block v-if="index!=0">
				<image class="connect-img" src="https://mmbiz.qpic.cn/mmbiz_png/w5pLFvdua9FquzibbuL4TMQyMbRKaQyUhgdxT7GJSxJfJvKpwibRWy0FW1GnLHLuEMrtIbWnRjHIeDgU9gpcRhdQ/0"
