				...
				<view class="content">
					<view class="content-container">
						...
						<view class="open-hot mb2 text-overflow" @tap="goDetail(item)">
							...
							<image lazy-load="true" class="img4" src="https://mmbiz.qpic.cn/mmbiz_png/w5pLFvdua9GT2o2aCDJf7rjLOUlbtTERziauZWDgQPHRlOiac7NsMqj5Bbz1VfzicVr9BqhXgVmBmOA2AuE7ZnMbA/0"
								 mode="widthFix"></image>
						</view>
	...
	export default {
		...
		methods: {
			...
			sendHot(count) {
				...
				const sendData = {id: this.sendId, hot: this.sendCount, type: this.type};
				uni.showLoading({
					title:"助力中..."
				})
