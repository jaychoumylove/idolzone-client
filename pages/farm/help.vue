<template>
	<view class='help-container'>
		...
		<view class='msg' v-if="info.res.remain"><text>今天还可以帮助不同的好友加速{{info.res.remain}}次</text></view>
		<navigator open-type="reLaunch" class='continue-btn' url='/pages/open/open'>继续冲榜 ></navigator>
	</view>
</template>
